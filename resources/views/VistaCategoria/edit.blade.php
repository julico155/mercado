...
@section('content')
        <div class="w-full lg:w-1/2 mx-auto my-4">
            ...
            <form action="{{ route('categoria.update', $c->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="categoria" id="categoria" required value="{{$c->categoria}}"
                ...
                <div class="flex items-center justify-between mb-4">
                    <button
                        ...
                        <button
                        class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"><a href="{{ route('categoria.index') }}">Cancelar</a></button>
                </div>
            </form>
        </div>
@endsection
