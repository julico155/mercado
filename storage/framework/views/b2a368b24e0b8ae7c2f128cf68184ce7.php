<?php $__env->startSection('content'); ?>
    <div class="container mx-auto">
        <div class="overflow-x-auto mx-auto bg-white shadow-md rounded px-8 py-6 mt-8">
                ...
                <form action="<?php echo e(route('empresa.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
    ...
    <div class="container mx-auto">
        <div class="overflow-x-auto my-6 shadow-md rounded">
            <table class="min-w-full bg-white border border-gray-300">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            <td class="text-center py-2 px-4 border-b">
                                ...
                                <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                    <img class="object-cover w-full h-full rounded-full"
                                        src="<?php echo e(asset($producto->profile_photo_path)); ?>"
                                        alt="" loading="lazy" />
                            ...
                            <td class="text-center py-2 px-4 border-b">
                                <p class="font-semibold text-left">
                                    <?php echo e($producto->name); ?></p>
                                <p class="text-xs text-gray-600 dark:text-gray-400 text-left">
                                    <?php echo e($producto->email); ?>

                                </p>
                            </td>

                            <td class="text-center py-2 px-4 border-b">
                                <a href="<?php echo e(route('empresa.edit', $producto->id)); ?>"
                                    class="text-green-500 hover:text-green-700 mr-2">
                                    Edit
                                </a>
                                <form action="<?php echo e(route('empresa.destroy', $producto->id)); ?>" method="POST"
                                    class="inline-block">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mauricio\mercadoverde\resources\views/VistaEmpresa/create.blade.php ENDPATH**/ ?>