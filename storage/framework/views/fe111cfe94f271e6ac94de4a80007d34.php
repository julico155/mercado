        ...
        <div class="overflow-x-auto mx-auto bg-white shadow-md rounded px-8 py-6 mt-8">
            ...
            <div class="max-w-lg mx-auto bg-white shadow-lg rounded-lg overflow-hidden my-6">
                ...
                <div class="p-4">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Cantidad disponible: <?php echo e($s->cantidad); ?></p>
                        ...
                        <form action="<?php echo e(route('carrito.update', $p->id)); ?>" method="post">
                            ...
                            <div class="flex justify-start">
                                <input type="number" name="cantidad" placeholder="Cantidad" required min="1"
                                    max="<?php echo e($s->cantidad); ?>" class="border border-gray-300 px-4 py-2 rounded-l-md w-32">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mercadoverde\resources\views/VistaEmpresa/productoShow.blade.php ENDPATH**/ ?>