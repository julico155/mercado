...
<div class="flex flex-wrap">
    <div class="w-full lg:w-1/2 px-4 mb-4">
        <h2 class="text-2xl my-4 ml-4">
            Marca</h2>
        <form action="<?php echo e(route('marca.store')); ?>" method="POST" enctype="multipart/form-data"
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center py-2 px-4 border-b">
                                <a href="<?php echo e(route('marca.edit', $marca->id)); ?>"
                                    class="mr-2">
                                    Editar
                                </a>
                                <form action="<?php echo e(route('marca.destroy', $marca->id)); ?>" method="POST"
                                    class="inline-block">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mercadoverde - copia\resources\views/VistaMarca/index.blade.php ENDPATH**/ ?>