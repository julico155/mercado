...
<?php endif; ?>
    ...
    <footer
        ...
        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Mauricio</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Evelin</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Ivan</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Lizsandra</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Alejandra</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Anibal</a>
            </li>
            <li>
                <a href="#" class="hover:underline">Yelsi</a>
            </li>
        </ul>
    </footer>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\mauricio\mercadoverde\resources\views/dashboard.blade.php ENDPATH**/ ?>