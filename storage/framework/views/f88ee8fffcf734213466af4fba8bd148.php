<?php $__env->startSection('content'); ?>
    <div class="w-full lg:w-1/2 mx-auto mb-4">
        <h2 class="text-2xl font-bold text-green-500 my-4 ml-4">
            Categorias generales para todas las empresas (admin)</h2>
    ...
    <div class="w-full lg:w-1/2 mx-auto mb-4">
        <div class="overflow-x-auto my-6 shadow-md rounded">
            <table class="min-w-full bg-white border border-gray-300">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center py-2 px-4 border-b">
                                <p class="font-semibold text-left">
                                    <?php echo e($producto->id); ?></p>
                            </td>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mauricio\mercadoverde\resources\views/VistaEmpresa/categoriaCreate.blade.php ENDPATH**/ ?>