        ...
        <div class="space-y-4 p-4">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('AdmUsuario')): ?>
                        ...
                        <div class="relative py-4" x-data="{ isOpen: false }" @mouseover="isOpen = true"
                            ...
                            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['active' => request()->routeIs('empresa.create')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('empresa.create'))]); ?>
                                <?php echo e(__('->Gestion de Usuarios')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('empresa.create'))]); ?>
                                <?php echo e(__('->Gestion de Compra')); ?>
...
<?php endif; ?>
                            ...
                            <ul class="absolute left-0 z-10 py-2 mt-2 space-y-2 text-sm bg-white border border-gray-200 rounded-md shadow-lg w-40"
                                ...
                                <li><a href="<?php echo e(route('proveedor.index')); ?>"
                                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100"><?php echo e(__('Gestionar Proveedor')); ?></a>
                                </li>
                            </ul>
                        </div>
                    <?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('empresa.create'))]); ?>
                                <?php echo e(__('->Gestion de Venta')); ?>
...
<?php endif; ?>
                            ...
                            <ul class="absolute left-0 z-10 py-2 mt-2 space-y-2 text-sm bg-white border border-gray-200 rounded-md shadow-lg w-40"
                                ...
                                x-transition:leave-end="opacity-0 transform scale-95" @mouseover="isOpen = true"
                                @mouseleave="isOpen = false">
                                <li><a href="<?php echo e(route('venta.index')); ?>"
                                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100"><?php echo e(__('Gestionar Venta')); ?></a>
                                </li>
...
<?php endif; ?>
<?php $component->withAttributes(['active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('empresa.create'))]); ?>
                                <?php echo e(__('->Gestion de Insumos')); ?>
...
<?php endif; ?>
                            ...
                            <ul class="absolute left-0 z-10 py-2 mt-2 space-y-2 text-sm bg-white border border-gray-200 rounded-md shadow-lg w-40"
                                ...
                                x-transition:leave-end="opacity-0 transform scale-95" @mouseover="isOpen = true"
                                @mouseleave="isOpen = false">
                                <li><a href="<?php echo e(route('marca.index')); ?>"
                                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100"><?php echo e(__('Gestionar Marca')); ?></a>
                                </li>
                            </ul>
                        </div>
                    <?php endif; ?>
...
<?php endif; ?>
                            ...
                            <ul class="absolute left-0 z-10 py-2 mt-2 space-y-2 text-sm bg-white border border-gray-200 rounded-md shadow-lg w-40"
                                ...
                                x-transition:leave-end="opacity-0 transform scale-95" @mouseover="isOpen = true"
                                @mouseleave="isOpen = false">
                                <li><a href="<?php echo e(route('categoria.index')); ?>"
                                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100"><?php echo e(__('Gestionar Categoria')); ?></a>
                                </li>
...
<?php /**PATH C:\xampp\htdocs\mercadoverde - copia\resources\views/navigation-menu.blade.php ENDPATH**/ ?>