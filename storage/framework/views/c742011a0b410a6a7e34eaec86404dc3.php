<?php $__env->startSection('usuario'); ?>
    <div class="w-full lg:w-1/2 mx-auto mb-4">
        <h2 class="text-2xl font-bold text-green-500 my-4 ml-4">
            Roles</h2>
        <form action="<?php echo e(route('rol.store')); ?>" method="POST" enctype="multipart/form-data"
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center py-2 px-4 border-b">
                                <a href="<?php echo e(route('rol.edit', $rol->id)); ?>"
                                    class="text-green-500 hover:text-green-700 mr-2">
                                    Edit
                                </a>
                                <a href="<?php echo e(route('rol.assign_permissions', $rol->id)); ?>"
                                    class="text-green-500 hover:text-green-700 mr-2">
                                    permisos
                                </a>
                                <form action="<?php echo e(route('rol.destroy', $rol->id)); ?>" method="POST"
                                    class="inline-block">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mercadoverde\resources\views/roles/index.blade.php ENDPATH**/ ?>